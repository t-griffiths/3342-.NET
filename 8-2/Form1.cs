    ...
    public partial class Form1 : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            //adds current score to list
            scoreList.Add(Convert.ToInt32(txtbxScore.Text));
        ...
        {
            string result = "";
            //puts each value in list into a string with a new line between each value
            //that shows in new window on click
            for (int i = 0; i < scoreList.Count; i++)
            {
                    result += scoreList[i].ToString() + "\n";
            }
