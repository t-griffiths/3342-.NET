...
namespace InvoiceTotal
{
    public partial class frmInvoiceTotal : Form
    {
        ...
        {
            frmSalesTax taxForm = new frmSalesTax();
        ...
        {
            //reference second form and get taxFromForm string from other form

            txtTax.Text = frmSalesTax.taxFromForm;
            label6.Text = "Tax " + frmSalesTax.taxFromForm + "%";
        }
    }
}